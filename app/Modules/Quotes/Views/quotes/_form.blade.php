...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">{{ $quote->client->name }}</div>
            <div class="panel-body">
                ...
                <div class="contact">
                    <span><b>Email: </b>{!! $quote->client->email !!}</span>
                    <span><b>Phone: </b>{!! $quote->client->phone !!}</span>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    {!! Form::label('number', 'Quotes #:', ['class' => 'col-sm-6']) !!}
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('issued_date', $quote->issued_date_formatted, ['class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('due_date', $quote->due_date_formatted, ['class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('status_id', $quote->statuses(), $quote->status_id, ['class' => 'form-control input-sm']) !!}
                    </div>
                </div>
    ...
    <table class="table table-hover" id="item-table">
            ...
            @if($quote->items->count())
                @foreach ($quote->items as $item)
                    <tr class="item" id="tr-item-{{ $item->id }}">
                        ...
                        <td>{!! $item->total !!}</td>
                        <td>
                            <a href="{!! route('quotes.item.delete', $item->id) !!}" onclick="return confirm('Are you sure you wish to delete this record?')">
                                <i class="glyphicon glyphicon-remove"></i>
                            </a>
                        </td>
                    </tr>
        ...
        <tfoot>
            <tr>
                <td colspan="5"></td>
                <td><b>Subtotal</b></td>
                <td>{!! $quote->subtotal_formatted !!}</td>
                <td></td>
            </tr>
            <tr>
                <td colspan="5"></td>
                <td><b>Invoice Tax</b></td>
                <td>{!! $quote->tax_formatted !!}</td>
                <td></td>
            </tr>
            <tr>
                <td colspan="5"></td>
                <td><b>Total</b></td>
                <td>{!! $quote->total_formatted !!}</td>
                <td></td>
            </tr>
        <tfoot>
    </table>
...
<div class="row clearfix">   
    <div class="col-sm-12">
        <div class="form-group">
            {!! Form::label('terms', 'Terms:', ['class' => 'col-sm-12 pull-left']) !!}
            <div class="col-sm-12">
                {!! Form::textarea('terms', null, ['class' => 'form-control', 'rows' => 4]) !!}
            </div>
        </div>

        @include('errors._ajax-form-errors', ['id'=>'update-quote-error-response'])
...
<div class="form-group">
    <div class="col-sm-3 col-sm-offset-9">
        ...
        <a href="{{ route('quotes.index') }}" class="btn btn-default">Back to list</a>
        <a href="javascript:void(0)" class="btn btn-default submit-quote">Create</a>
...
$('body').on('click', '.submit-quote', function(e){
    ...
    $.ajax({
        ...
        error: function(data){
            ...
            $('#update-quote-error-response').html(responseString);
            $('.ajax-error').show();
        }
    });
});
